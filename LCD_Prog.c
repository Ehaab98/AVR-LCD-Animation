...
void LCD_SendSpecialChar(u8* Copy_U8Patterns, u8 Copy_CharNumber, u8 Copy_XPosition, u8 Copy_YPosition)
{
	...
	LCD_VidCursorPosition(Copy_XPosition,Copy_YPosition);
	LCD_VidSendData(Copy_CharNumber);
